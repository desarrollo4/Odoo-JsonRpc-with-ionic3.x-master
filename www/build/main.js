...
NotificacionesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-notificaciones',template:/*ion-inline-start:"C:\xampp\htdocs\Odoo-JsonRpc-with-ionic3.x-master\src\pages\notificaciones\notificaciones.html"*/'\n\n\n\n<ion-content>\n\n\n\n<ion-list>\n\n  <ion-item>\n\n    <ion-label>Notificacion</ion-label>\n\n  </ion-item>\n\n\n\n</ion-list>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\xampp\htdocs\Odoo-JsonRpc-with-ionic3.x-master\src\pages\notificaciones\notificaciones.html"*/,
    }),
...
var MyApp = (function () {
    ...
    MyApp.prototype.initLogin = function () {
        ...
        if (localStorage.getItem("token")) {
            ...
            var url_1 = (jsonData["web.base.url"]) ? jsonData["web.base.url"] : "http://erp.allser.com.co:8088";
            var db = jsonData["db"];
            this.odooRpc.init({
                odoo_server: url_1,
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\xampp\htdocs\Odoo-JsonRpc-with-ionic3.x-master\src\app\app.html"*/'<ion-menu [content]="content" side="start" id="salesman">\n\n  <ion-header>\n\n    <ion-toolbar color="secondary">\n\n      <ion-title>Menú</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pagesSalesman" (click)="openPage(p)">\n\n        <ion-label stacked icon-start>\n\n          <h2>\n\n            <ion-icon [name]="p.icon" item-left></ion-icon>{{p.title}}\n\n          </h2>\n\n        </ion-label>\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n</ion-menu>\n\n\n\n<ion-menu [content]="content" side="start" id="technician">\n\n  <ion-header>\n\n    <ion-toolbar color="primary">\n\n      <ion-title>Menú</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let q of pagesTechnician" (click)="openPage(q)">\n\n        <ion-label stacked icon-start>\n\n          <h2>\n\n            <ion-icon [name]="q.icon" item-left></ion-icon>{{q.title}}\n\n          </h2>\n\n        </ion-label>\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n</ion-menu>\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\xampp\htdocs\Odoo-JsonRpc-with-ionic3.x-master\src\app\app.html"*/,
