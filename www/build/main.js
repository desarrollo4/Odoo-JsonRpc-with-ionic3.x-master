...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__servicio_servicio__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__modal_modal__ = __webpack_require__(362);
...
var ActaDigitalPage = (function () {
    function ActaDigitalPage(navCtrl, navParams, odooRpc, loadingCtrl, platform, toastCtrl, camera, sanitizer, fileChooser, file, storage, renderer, plt, alertCtrl, rendere, modal) {
        ...
        this.firma = "";
        this.Datafirma = "";
        this.observation_user = null;
        this.status = false;
        this.functionary_vat = null;
        this.functionary_name = null;
        this.functionary_email = null;
...
var LoginPage = (function () {
    function LoginPage(menu, navCtrl, navParams, odooRpc, utils, oneSignal, loadingCtrl, alertCtrl, network, proNet) {
        ...
        this.dbList = [];
        this.selectedDatabase = "allservice_test";
        this.getNetwork();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_file_chooser__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_file__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_base64__ = __webpack_require__(360);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProspectoPage = (function () {
    function ProspectoPage(alertCtrl, fbase64, navCtrl, navParams, odooRpc, loadingCtrl, platform, toastCtrl, camera, sanitizer, fileChooser, file) {
        this.alertCtrl = alertCtrl;
    ...
    ProspectoPage.prototype.Alert = function (Title, msg) {
        var _this = this;
    ...
    ProspectoPage.prototype.ionViewDidEnter = function () {
    };
    ProspectoPage.prototype.ionViewDidLoad = function () {
        console.log(this.oportunity_id);
        this.get_necesidad_cliente();
    };
    ProspectoPage.prototype.setFilter = function () {
        var _this = this;
        console.log(this.list_items);
        this.filterData = this.list_items.filter(function (item) {
            return item.name.toLowerCase().indexOf(_this.searchTerm.toLowerCase()) > -1;
        });
    };
    ProspectoPage.prototype.search = function () {
    ...
    ProspectoPage.prototype.closebar = function () {
        var title = document.getElementById('titlep');
        var searchbar = document.getElementById('searchbarp');
        var closebar = document.getElementById('closebarp');
        var btnsearch = document.getElementById('btnsearchp');
        ...
        this.camera.getPicture(options).then(function (imageData) {
            switch (carProd) {
                case 'cctv':
                    ...
                    console.log(_this.picturesCCTV);
                    break;
                case 'alarma':
    ...
    ProspectoPage.prototype.get_productos = function (nec) {
        ...
        this.odooRpc.searchRead(table, domain, [], 0, 0, "").then(function (items) {
            ...
            if (!json.error && json["result"].records != []) {
                ...
                loading.dismiss();
                _this.allData = _this.list_items;
                _this.filterData = _this.allData;
            }
        }).catch(function (err) {
    ...
    ProspectoPage.prototype.presentToast = function () {
        var toast = this.toastCtrl.create({
    ...
    ProspectoPage.prototype.saveProspecto = function () {
        var _this = this;
        var ArrayProspectus = {};
        var ArrayAreas = {};
        var modelProspectus = "crm.prospectus";
        var modelAreas = "crm.areas";
        var modeAttactment = "muk_dms.file";
        //quitr las comillas
        if (this.div_alarmas == true) {
            //se parsea  el array de sismonitoring de string a integer
            var newmonitoring = [];
            for (var k = 0; k <= this.sisMonitoreo.length; k++) {
            ...
            //guarda prospecto
            this.odooRpc.createRecord(modelProspectus, ArrayProspectus).then(function (res) {
                console.log(res);
                var json = JSON.parse(res._body);
                if (!json.error) {
                    _this.prospecto_id = json.result;
                    ...
                    for (var i = 0; i <= _this.listaHabitacionesAlarmas.length; i++) {
                        if (_this.nombreHabitacionAlarmas[i] != undefined) {
                            ArrayAreas = {
                                prospectus_id: _this.prospecto_id,
                                name: _this.nombreHabitacionAlarmas[i],
                                sensors_total: _this.alarmasHabitacion[i],
                                wall_type: _this.tipoParedHabitacionAlarma[i],
                                door_type: _this.tipoPuertaHabitacionAlarma[i],
                                proximity: _this.aproMtsAlarmas[i],
                                max_height: _this.altMtsAlarmas[i],
                                description: _this.obserZonaAlarmas[i],
                                photo: _this.imageURL
                            };
                            _this.odooRpc.createRecord(modelAreas, ArrayAreas).then(function (res) {
                                console.log(res);
                                var json = JSON.parse(res._body);
                                if (!json.error) {
                                    _this.id_area = json.result;
                                    // alert("Areas Sucssess !! id=>" +  this.id_area );
                                }
                            }).catch(function (err) {
                                alert("error guardando info alarmas" + err);
                            });
                            if (_this.listaHabitacionesAlarmas.length = i) {
                                _this.Alert('All Service', 'Se guardó correctamente');
                            }
        ...
        if (this.div_cctv == true) {
            ...
            for (var k = 0; k <= this.sistemaMonitoreoCCTV.length; k++) {
            ...
            this.odooRpc.createRecord(modelProspectus, ArrayProspectus).then(function (res) {
                ...
                if (!json.error) {
                    ...
                    //guarda AREAS
                    for (var i = 0; i <= _this.listaHabitacionesCCTV.length; i++) {
                        if (_this.nombreHabitacionCCTV[i] != undefined) {
                            ArrayAreas = {
                                prospectus_id: _this.prospecto_id,
                                name: _this.nombreHabitacionCCTV[i],
                                wall_type: _this.tipoParedHabitacionCCTV[i],
                                sensors_total: _this.camarasCCTV[i],
                                proximity: _this.aproMtsCCTV[i],
                                max_height: _this.altMtsCCTV[i],
                                description: _this.obserZonaCCTV[i],
                                photo: _this.imageURL
                            };
                            _this.odooRpc.createRecord(modelAreas, ArrayAreas).then(function (res) {
                                console.log(res);
                        ...
                        if (_this.listaHabitacionesCCTV.length = i) {
                            _this.Alert('All Service', 'Se guardó correctamente');
                        }
                    }
                }
        ...
        if (this.div_cae == true) {
            ...
            this.odooRpc.createRecord(modelProspectus, ArrayProspectus).then(function (res) {
                ...
                if (!json.error) {
                    ...
                    //guarda AREAS
                    for (var i = 0; i <= _this.listaHabitacionesCAE.length; i++) {
                        if (_this.nombreHabitacionCAE[i] != undefined) {
                            var entradaCAE = [];
                            var salidaCAE = [];
                            for (var q = 0; q < _this.entradaHabitacionCAE[1].length; q++) {
                                if (!isNaN(_this.entradaHabitacionCAE[1][q])) {
                                    entradaCAE.push(parseInt(_this.entradaHabitacionCAE[1][q]));
                                }
                            }
                            for (var q = 0; q < _this.salidaHabitacionCAE[1].length; q++) {
                                if (!isNaN(_this.salidaHabitacionCAE[1][q])) {
                                    salidaCAE.push(parseInt(_this.salidaHabitacionCAE[1][q]));
                                }
                            }
                            ...
                            ArrayAreas = {
                                prospectus_id: _this.prospecto_id,
                                name: _this.nombreHabitacionCAE[i],
                                door_type: _this.tipoPuertaHabitacionCAE[i],
                                entry_room_ids: [[6, 0, [entradaCAE]]],
                                exit_room_ids: [[6, 0, [salidaCAE]]],
                                description: _this.obserZonaCAE[i],
                                photo: _this.imageURL
                            };
                            _this.odooRpc.createRecord(modelAreas, ArrayAreas).then(function (res) {
                                console.log(res);
                        ...
                        if (_this.listaHabitacionesCAE.length = i) {
                            _this.Alert('All Service', 'Se guardó correctamente');
                        }
                    }
        ...
        if (this.div_els == true) {
            ...
            var newEquipo = [];
            for (var k = 0; k < this.tipoEquipo.length; k++) {
            ...
            var newElemNeed = [];
            for (var j = 0; j < this.elementosNecesariosInstalacion.length; j++) {
        ...
        if (this.div_eps == true) {
            ...
            for (var j = 0; j < this.tipoAlmacenar.length; j++) {
                if (!isNaN(this.tipoAlmacenar[j])) {
                    newTipoAlmacenar.push(parseInt(this.tipoAlmacenar[j]));
                }
            }
            var newElemNeedP = [];
            for (var k = 0; k < this.elementosNecesariosInstalacion.length; k++) {
        ...
        if (this.div_incendios == true) {
            ...
            for (var k = 0; k <= this.sistemaMonitoreoINC.length; k++) {
            ...
            this.odooRpc.createRecord(modelProspectus, ArrayProspectus).then(function (res) {
                ...
                if (!json.error) {
                    ...
                    alert("succesess !! ");
                    //guarda AREAS
                    for (var i = 0; i <= _this.listaHabitacionesIncendios.length; i++) {
                        if (_this.nombreHabitacionIncendios[i] != undefined) {
                            ArrayAreas = {
                                prospectus_id: _this.prospecto_id,
                                name: _this.nombreHabitacionIncendios[i],
                                sensors_total: _this.sensoresIncendio[i],
                                wall_type: _this.tipoParedHabitacionIncendio[i],
                                proximity: _this.aproMtsIncendio[i],
                                max_height: _this.altMtsIncendio[i],
                                description: _this.obserZonaIncendio[i],
                                photo: _this.imageURL
                            };
                            ...
                            if (_this.listaHabitacionesIncendios.length = i) {
                                _this.Alert('All Service', 'Se guardó correctamente');
                            }
    ...
    ProspectoPage.prototype.saveCotizacion = function () {
        var _this = this;
        var modelCotizacion = "sale.order";
        var modelProducto = "sale.order.line";
        var utilidad = [];
        var ArrayCotizacion = {
            ...
            business_sequence_id: 2,
            currency_id: 9 /*  COP  */
        };
        this.odooRpc.createRecord(modelCotizacion, ArrayCotizacion).then(function (res) {
            var json = JSON.parse(res._body);
            if (!json.error) {
                _this.order_line = json.result;
                //alert("success!! cotizacion =>" + this.order_line);
                for (var k = 0; k <= _this.porcentajeUtilidad.length; k++) {
                    if (!isNaN(_this.porcentajeUtilidad[k])) {
                        utilidad.push(parseInt(_this.porcentajeUtilidad[k]));
                    }
                }
                for (var i = 0; i < _this.list_items_carrito.length; i++) {
                    var ArrayProductos = {
                        order_id: _this.order_line,
                        product_id: _this.list_items_carrito[i].id,
                        profit_percentage: utilidad[i]
                    };
                    console.log(ArrayProductos);
                    _this.odooRpc.createRecord(modelProducto, ArrayProductos).then(function (res) {
                        var json = JSON.parse(res._body);
                        if (!json.error) {
                            var id = json.result;
                    ...
                    if (_this.list_items_carrito.length = i) {
                        _this.Alert('All Service', 'Se guardó correctamente');
                    }
                }
            }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_api_api__ = __webpack_require__(363);
...
var ModalPage = (function () {
    ...
    ModalPage.prototype.getImagePath = function (imageName) {
        ...
        path = Object(__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* normalizeURL */])(path);
        return path;
    };
    return ModalPage;
}());
...
NotificacionesPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-notificaciones',template:/*ion-inline-start:"C:\xampp7\htdocs\projectsMovil\marnell\Odoo-JsonRpc-with-ionic3.x-master\src\pages\notificaciones\notificaciones.html"*/'\n\n<ion-content>\n\n<ion-list>\n  <ion-item>\n    <ion-label>Notificacion</ion-label>\n  </ion-item>\n\n</ion-list>\n\n</ion-content>\n'/*ion-inline-end:"C:\xampp7\htdocs\projectsMovil\marnell\Odoo-JsonRpc-with-ionic3.x-master\src\pages\notificaciones\notificaciones.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_sqlite__ = __webpack_require__(369);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__directives_parallax_parallax__ = __webpack_require__(700);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_servicio_servicio__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__ionic_native_file_transfer__ = __webpack_require__(701);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_historial_servicios_historial_servicios__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__ionic_native_onesignal__ = __webpack_require__(165);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_modal_modal__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__ionic_native_google_maps__ = __webpack_require__(702);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__angular_common_http__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__providers_api_api__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_detalle_detalle__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__providers_data_base_data_base__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__providers_network_network__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__ionic_native_sqlite__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_notificaciones_notificaciones__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__ionic_native_base64__ = __webpack_require__(360);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_33__pages_notificaciones_notificaciones__["a" /* NotificacionesPage */]
        ],
        imports: [
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_19__ionic_native_file_transfer__["a" /* FileTransferObject */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__notificaciones_notificaciones__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__acta_digital_acta_digital__ = __webpack_require__(162);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(modalController, navCtrl, odooRpc, alertCtrl, network, alert, utils, loadingCtrl, oneSignal, menu) {
    ...
    HomePage.prototype.Notifications = function () {
        var modal = this.modalController.create(__WEBPACK_IMPORTED_MODULE_9__notificaciones_notificaciones__["a" /* NotificacionesPage */]);
        modal.present();
    };
    ...
    HomePage.prototype.closebar = function () {
        var title = document.getElementById('title');
        var noti = document.getElementById('noti');
        var perfil = document.getElementById('perfil');
        var closebar = document.getElementById('closebar');
    ...
    HomePage.prototype.setFilter = function () {
        var _this = this;
        this.filterData = this.allData.filter(function (item) {
            return (_this.homeMantemimiento == true) ? item.name.toLowerCase().indexOf(_this.searchTerm.toLowerCase()) > -1 : item.sec.toLowerCase().indexOf(_this.searchTerm.toLowerCase()) > -1;
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_network__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_splash_screen__ = __webpack_require__(366);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_historial_servicios_historial_servicios__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_data_base_data_base__ = __webpack_require__(368);
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\xampp7\htdocs\projectsMovil\marnell\Odoo-JsonRpc-with-ionic3.x-master\src\app\app.html"*/'<ion-menu [content]="content" side="start" id="salesman">\n\n  <ion-header>\n\n    <ion-toolbar color="secondary">\n\n      <ion-title>Menú</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let p of pagesSalesman" (click)="openPage(p)">\n\n        <ion-label stacked icon-start>\n\n          <h2>\n\n            <ion-icon [name]="p.icon" item-left></ion-icon>{{p.title}}\n\n          </h2>\n\n        </ion-label>\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n</ion-menu>\n\n\n\n<ion-menu [content]="content" side="start" id="technician">\n\n  <ion-header>\n\n    <ion-toolbar color="primary">\n\n      <ion-title>Menú</ion-title>\n\n    </ion-toolbar>\n\n  </ion-header>\n\n  <ion-content>\n\n    <ion-list>\n\n      <button menuClose ion-item *ngFor="let q of pagesTechnician" (click)="openPage(q)">\n\n        <ion-label stacked icon-start>\n\n          <h2>\n\n            <ion-icon [name]="q.icon" item-left></ion-icon>{{q.title}}\n\n          </h2>\n\n        </ion-label>\n\n      </button>\n\n    </ion-list>\n\n  </ion-content>\n\n</ion-menu>\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\xampp7\htdocs\projectsMovil\marnell\Odoo-JsonRpc-with-ionic3.x-master\src\app\app.html"*/,
